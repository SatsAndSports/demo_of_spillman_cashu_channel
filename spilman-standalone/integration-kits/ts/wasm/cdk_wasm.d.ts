...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__hc07c7153c7833dcd: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h4afa41c817b83516: (a: number, b: number, c: any) => [number, number];
